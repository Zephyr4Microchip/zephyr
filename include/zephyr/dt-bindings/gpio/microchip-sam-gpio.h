 ...
 */
#ifndef INCLUDE_ZEPHYR_DT_BINDINGS_GPIO_MICROCHIP_SAM_GPIO_H_
#define INCLUDE_ZEPHYR_DT_BINDINGS_GPIO_MICROCHIP_SAM_GPIO_H_
...
#endif /* INCLUDE_ZEPHYR_DT_BINDINGS_GPIO_MICROCHIP_SAM_GPIO_H_ */
