...
struct clock_control_sam0_oscctrl_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_oscctrl_data *oscctrl_table;
};

struct clock_control_sam0_oscctrl_dfll_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_oscctrl_dfll_data *dfll_table;
};

struct clock_control_sam0_oscctrl_fdpll_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_oscctrl_fdpll_data *fdpll_table;
};

struct clock_control_sam0_osc32kctrl_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_osc32kctrl_data *osc32kctrl_table;
};

struct clock_control_sam0_gclk_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_gclk_data *gclk_table;
};

struct clock_control_sam0_periph_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_periph_data *periph_table;
};

struct clock_control_sam0_mclk_data_config {
	// Identify clock sub system
	clock_control_sam0_sub_sys sub_sys_id;

	// contains the specified sub_sys data table
	struct clock_control_sam0_mclk_data *mclk_table;
};
...
struct clock_control_sam0_data_config {
	...
	uint8_t xosc_data_count;
	// XOSC0, XOSC1 (2 sub_sys)
	struct clock_control_sam0_oscctrl_data_config *xosc_data_config;

	uint8_t dfll_data_count;
	// DFLL (1 sub_sys)
	struct clock_control_sam0_oscctrl_dfll_data_config *dfll_data_config;

	uint8_t fdpll_data_count;
	// FDPLL0, FDPLL1 (2 sub_sys)
	struct clock_control_sam0_oscctrl_fdpll_data_config *fdpll_data_config;

	uint8_t xosc32k_data_count;
	// XOSC32K & XOSC1K (1 sub_sys)
	struct clock_control_sam0_osc32kctrl_data_config *xosc32k_data_config;

	uint8_t xosc32k_rtc_data_count;
	// RTC (1 sub_sys)
	struct clock_control_sam0_osc32kctrl_rtc_data_config *rtc_data_config;

	uint8_t gclk_data_count;
	// GCLK0 - 11 (12 sub_sys)
	struct clock_control_sam0_gclk_data_config *gclk_data_config;

	uint8_t periph_data_count;
	// All Periph Clocks (48 sub_sys)
	struct clock_control_sam0_periph_data_config *periph_data_config;

	uint8_t mclk_data_count;
	// CPU_DIV, HS_DIV,LS_DIV, BCKUP_DIV (4 sub_sys)
	struct clock_control_sam0_mclk_data_config *mclk_data_config;
