...
struct clock_mchp_subsys_dpll_config {
	...
	/** @brief Determines division factor of PLL input reference frequency (1 ≤ REFDIV ≤ 63) */
...
struct clock_mchp_subsys_dpll_out_config {
	/** @brief Determines the division factor of PLL VCO frequency output 1 ≤ POSTDIV ≤ 63 */
