...
static void device_config_pmd_reg(device_sleep_action_id_t action)
{
	if (action == DEVICE_SLEEP_ENTER_SLEEP) {
		 ...
		 */
		if ((pmd_reg.sercom0 != 0U) || (pmd_reg.sercom1 != 0U)) {
		...
		if (pmd_reg.sercomi2c != 0U) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN1 & CFG_CFGPCLKGEN1_SERCOM2CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN1 &
						      CFG_CFGPCLKGEN1_SERCOM2CSEL_Msk) >>
						     CFG_CFGPCLKGEN1_SERCOM2CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
		...
		if (pmd_reg.tc0 != 0U) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN4 & CFG_CFGPCLKGEN4_TC0CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN4 &
						      CFG_CFGPCLKGEN4_TC0CSEL_Msk) >>
						     CFG_CFGPCLKGEN4_TC0CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
		...
		if (pmd_reg.tc1 != 0U) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN4 & CFG_CFGPCLKGEN4_TC1CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN4 &
						      CFG_CFGPCLKGEN4_TC1CSEL_Msk) >>
						     CFG_CFGPCLKGEN4_TC1CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
		...
		if ((pmd_reg.tc2 != 0U) || (pmd_reg.tc3 != 0U)) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN4 & CFG_CFGPCLKGEN4_TC23CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN4 &
						      CFG_CFGPCLKGEN4_TC23CSEL_Msk) >>
						     CFG_CFGPCLKGEN4_TC23CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
		...
		if ((pmd_reg.tc4 != 0U) || (pmd_reg.tc5 != 0U)) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN4 & CFG_CFGPCLKGEN4_TC54CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN4 &
						      CFG_CFGPCLKGEN4_TC54CSEL_Msk) >>
						     CFG_CFGPCLKGEN4_TC54CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
		...
		if ((pmd_reg.tc6 != 0U) || (pmd_reg.tc7 != 0U)) {
			...
			if ((CFG_REGS->CFG_CFGPCLKGEN4 & CFG_CFGPCLKGEN4_TC67CD_Msk) != 0U) {
				temp_val = (uint8_t)((CFG_REGS->CFG_CFGPCLKGEN4 &
						      CFG_CFGPCLKGEN4_TC67CSEL_Msk) >>
						     CFG_CFGPCLKGEN4_TC67CSEL_Pos);
				select = (device_clk_src_id_t)temp_val;
...
static void device_config_cldo(device_sleep_action_id_t action)
{
	...
	if (action == DEVICE_SLEEP_ENTER_SLEEP) {
		...
		tmp |= ((uint16_t)1U << 11U);
		device_write_rf_reg(0x15, tmp); /* [0] BIAS_tsens_en = 0,
						 * [7] BIAS_CTAT_en = 0, [11]
