...
/**
 * @file wdt_mchp_u2251.c
 * @brief WDT driver implementation for Microchip Watchdog peripheral U2251
 *
...
LOG_MODULE_REGISTER(wdt_mchp_u2251, CONFIG_WDT_LOG_LEVEL);

#define DT_DRV_COMPAT microchip_wdt_u2251 /*Device Tree Driver Compatibility */
/**
