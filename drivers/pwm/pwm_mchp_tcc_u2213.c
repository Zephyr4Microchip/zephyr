...
/**
 * @file pwm_mchp_tcc_u2213.c
 * @brief PWM driver for Microchip tcc u2213 peripheral.
 *
 * This file provides the implementation of pwm functions
 * for Microchip tcc u2213 Peripheral.
 */
 ...
 ******************************************
 */
#define DT_DRV_COMPAT microchip_pwm_tcc_u2213

LOG_MODULE_REGISTER(pwm_mchp_tcc_u2213, CONFIG_PWM_LOG_LEVEL);
...
#define PWM_MCHP_CLOCK_ASSIGN(n)                                                                   \
	...
	.pwm_clock.host_core_sync_clk = {.dev = DEVICE_DT_GET(                                     \
	...
	COND_CODE_1(DT_NODE_EXISTS(DT_INST_CLOCKS_CTLR_BY_NAME(n, osc32kctrl)),         \
			(.pwm_clock.periph_async_clk = {                                  \
				.dev = DEVICE_DT_GET(                                          \
					DT_INST_CLOCKS_CTLR_BY_NAME(n, osc32kctrl)),         \
