...
/**
 * @file comparator_mchp_ac_u2501.c
 * @brief Microchip AC-U2501 analog comparator driver
 *
 * Implements Zephyr's analog comparator API for the AC-U2501 peripheral.
 */
 ...
 *******************************************/
#define DT_DRV_COMPAT microchip_ac_u2501

LOG_MODULE_REGISTER(comparator_mchp_ac_u2501, CONFIG_COMPARATOR_LOG_LEVEL);
