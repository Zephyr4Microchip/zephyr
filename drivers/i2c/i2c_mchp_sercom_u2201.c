...
/**
 * @file i2c_mchp_sercom_u2201.c
 * @brief I2C driver for Microchip SERCOM_U2201 peripheral.
 *
 * This driver provides an implementation of the Zephyr I2C API for the
 * Microchip SERCOM_U2201 peripheral.
 *
...
LOG_MODULE_REGISTER(i2c_mchp_sercom_u2201);
 ...
 *******************************************/
/* Device tree compatible string for Microchip sercom u2201. */
