...
#define DT_DRV_COMPAT atmel_samd5x_gclk
...
{
	// TODO
	clock_control_sam0_gclk_type gclk_type = (clock_control_sam0_gclk_type)sys;
	if (gclk_type < 0 || gclk_type >= CLOCK_CONTROL_SAM0_GCLK_TYPE_NONE) {
		return -1; // -error no (No clock selected)
	}
...
static const struct clock_control_driver_api clock_control_sam0_driver_gclk_api = {
	.on = clock_control_sam0_gclk_on,
	.off = clock_control_sam0_gclk_off,
	.async_on = clock_control_sam0_gclk_async_on,
	.get_rate = clock_control_sam0_gclk_get_rate,
	.get_status = clock_control_sam0_gclk_get_status,
	.set_rate = clock_control_sam0_gclk_set_rate,
	.configure = clock_control_sam0_gclk_configure,
};
...
DEVICE_DT_INST_DEFINE(0, clock_control_sam0_gclk_init, NULL, NULL, NULL, PRE_KERNEL_1,
