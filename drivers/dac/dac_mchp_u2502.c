...
/**
 * @file dac_mchp_u2502.c
 * @brief DAC Driver for Microchip DAC U2502 Peripheral.
 *
 * This file contains the implementation of a DAC driver
 * for microchip dac_u2502 peripheral.
 *
...
LOG_MODULE_REGISTER(dac_mchp_u2502, CONFIG_DAC_LOG_LEVEL);
...
/**
 * @brief DAC channel configuration for Microchip U2502 peripheral.
 *
