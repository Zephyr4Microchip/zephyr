...
/* UART Interrupt Level Select Enum (0–7) */
typedef enum {
	UART_INTLVL_0 = 0x0U,
	UART_INTLVL_1 = 0x1U,
	UART_INTLVL_2 = 0x2U,
...
#elif defined(CONFIG_SOC_P33AK256MPS306)
#define UART_INST_MAX 4
uint32_t BIT_TXEN[UART_INST_MAX] = {_U1CON_TXEN_MASK, _U2CON_TXEN_MASK, _U3CON_TXEN_MASK, _U4CON_TXEN_MASK};
uint32_t BIT_RXEN[UART_INST_MAX] = {_U1CON_RXEN_MASK, _U2CON_RXEN_MASK, _U3CON_RXEN_MASK, _U4CON_RXEN_MASK};
uint32_t BIT_UARTEN[UART_INST_MAX] = {_U1CON_ON_MASK, _U2CON_ON_MASK, _U3CON_ON_MASK, _U4CON_ON_MASK};
uint32_t BIT_TXBF[UART_INST_MAX] = {_U1STAT_TXBF_MASK, _U2STAT_TXBF_MASK, _U3STAT_TXBF_MASK, _U4STAT_TXBF_MASK};
uint32_t BIT_TXBE[UART_INST_MAX] = {_U1STAT_TXBE_MASK, _U2STAT_TXBE_MASK, _U3STAT_TXBE_MASK, _U4STAT_TXBE_MASK};
uint32_t BIT_RXBF[UART_INST_MAX] = {_U1STAT_RXBF_MASK, _U2STAT_RXBF_MASK, _U3STAT_RXBF_MASK, _U4STAT_RXBF_MASK};
uint32_t BIT_RXBE[UART_INST_MAX] = {_U1STAT_RXBE_MASK, _U2STAT_RXBE_MASK, _U3STAT_RXBE_MASK, _U4STAT_RXBE_MASK};
uint32_t BIT_PERIE[UART_INST_MAX] = {_U1STAT_PERIE_MASK, _U2STAT_PERIE_MASK, _U3STAT_PERIE_MASK, _U4STAT_PERIE_MASK};
uint32_t BIT_ABDOVIE[UART_INST_MAX] = {_U1STAT_ABDOVIE_MASK, _U2STAT_ABDOVIE_MASK,
				       _U3STAT_ABDOVIE_MASK, _U4STAT_ABDOVIE_MASK};
uint32_t BIT_CERIE[UART_INST_MAX] = {_U1STAT_CERIE_MASK, _U2STAT_CERIE_MASK, _U3STAT_CERIE_MASK, _U4STAT_CERIE_MASK};
uint32_t BIT_FERIE[UART_INST_MAX] = {_U1STAT_FERIE_MASK, _U2STAT_FERIE_MASK, _U3STAT_FERIE_MASK, _U4STAT_FERIE_MASK};
uint32_t BIT_RXBKIE[UART_INST_MAX] = {_U1STAT_RXBKIE_MASK, _U2STAT_RXBKIE_MASK,
				      _U3STAT_RXBKIE_MASK, _U4STAT_RXBKIE_MASK};
uint32_t BIT_RXFOIE[UART_INST_MAX] = {_U1STAT_RXFOIE_MASK, _U2STAT_RXFOIE_MASK,
				      _U3STAT_RXFOIE_MASK, _U4STAT_RXFOIE_MASK};
uint32_t BIT_TXCIE[UART_INST_MAX] = {_U1STAT_TXCIE_MASK, _U2STAT_TXCIE_MASK, _U3STAT_TXCIE_MASK, _U4STAT_TXCIE_MASK};
uint32_t BIT_PERIF[UART_INST_MAX] = {_U1STAT_PERIF_MASK, _U2STAT_PERIF_MASK, _U3STAT_PERIF_MASK, _U4STAT_PERIF_MASK};
uint32_t BIT_ABDOVIF[UART_INST_MAX] = {_U1STAT_ABDOVIF_MASK, _U2STAT_ABDOVIF_MASK,
				       _U3STAT_ABDOVIF_MASK, _U4STAT_ABDOVIF_MASK};
uint32_t BIT_CERIF[UART_INST_MAX] = {_U1STAT_CERIF_MASK, _U2STAT_CERIF_MASK, _U3STAT_CERIF_MASK, _U4STAT_CERIF_MASK};
uint32_t BIT_FERIF[UART_INST_MAX] = {_U1STAT_FERIF_MASK, _U2STAT_FERIF_MASK, _U3STAT_FERIF_MASK, _U4STAT_FERIF_MASK};
uint32_t BIT_RXBTIF[UART_INST_MAX] = {_U1STAT_RXBKIF_MASK, _U2STAT_RXBKIF_MASK,
				      _U3STAT_RXBKIF_MASK, _U4STAT_RXBKIF_MASK};
uint32_t BIT_RXFOIF[UART_INST_MAX] = {_U1STAT_RXFOIF_MASK, _U2STAT_RXFOIF_MASK,
				      _U3STAT_RXFOIF_MASK, _U4STAT_RXFOIF_MASK};
uint32_t BIT_TXCIF[UART_INST_MAX] = {_U1STAT_TXCIF_MASK, _U2STAT_TXCIF_MASK, _U3STAT_TXCIF_MASK, _U4STAT_TXCIF_MASK};
uint32_t BIT_CLOCK_MODE[UART_INST_MAX] = {_U1CON_CLKMOD_MASK, _U2CON_CLKMOD_MASK,
					  _U3CON_CLKMOD_MASK, _U4CON_CLKMOD_MASK};
uint32_t BIT_TXWM_POS[UART_INST_MAX] = {_U1STAT_TXWM_POSITION, _U2STAT_TXWM_POSITION,
					_U3STAT_TXWM_POSITION, _U4STAT_TXWM_POSITION};
uint32_t BIT_RXWM_POS[UART_INST_MAX] = {_U1STAT_RXWM_POSITION, _U2STAT_RXWM_POSITION,
					_U3STAT_RXWM_POSITION, _U4STAT_RXWM_POSITION};

/* Mask for receiver buffer */
uint32_t BIT_MASK_RCVR[UART_INST_MAX] = {_U1RXB_RXB_MASK, _U2RXB_RXB_MASK, _U3RXB_RXB_MASK, _U4RXB_RXB_MASK};
